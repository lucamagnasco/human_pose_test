...
# TODO: improve tracking accuracy --> unstable points. For ex: looses foot when kick impact
# TODO: other measurements
# TODO: Average multiple measurements for same player and compare to others.
# todo: Add professional player video to measure and compare to amateur for improvement with detected KPIs.
